...
const Update = () => {
  ...
  useEffect(() => {
    axios
      .get("https://solar-api-d41x.onrender.com/u_data/" + id)
  ...
  const Update = async (id) => {
    ...
    await axios
      .post("https://solar-api-d41x.onrender.com/update/" + id, data)
      .then((response) => {
        console.log(response.data);
        navigate("/viewdata");
      });
      ...
      >
        <div className="box w-100">
          <div className="m-auto text-center border-purple-500 boder">
            ...
            <input
              type="name"
              className="mt-2 rounded fs-5 w-25"
              value={name}
              placeholder="name"
              onChange={(e) => {
            ...
            <input
              ...
              onClick={() => Update(id)}
              value="update"
              className="p-2 mt-3 text-white rounded bg-success"
            ></input>
          </div>
        </div>
      </div>
